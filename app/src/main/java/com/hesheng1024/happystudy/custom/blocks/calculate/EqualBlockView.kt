...
class EqualBlockView : BaseLogicBlockView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int)
        ...
        View.inflate(context, R.layout.layout_equal_block, this)
        mLeftCalculateBg = findViewById(R.id.bg_equal_block_left)
        mRightCalculateBg = findViewById(R.id.bg_equal_block_right)
        initView()
    }
