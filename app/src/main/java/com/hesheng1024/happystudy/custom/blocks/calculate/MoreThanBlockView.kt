...
class MoreThanBlockView : BaseLogicBlockView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int)
        ...
        View.inflate(context, R.layout.layout_more_than_block, this)
        mLeftCalculateBg = findViewById(R.id.bg_more_than_block_left)
        mRightCalculateBg = findViewById(R.id.bg_more_than_block_right)
        initView()
    }
