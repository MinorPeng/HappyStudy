...
class DrawRingBlockView : BaseRelativeBlockView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int)
        ...
        mEtCx = findViewById(R.id.et_draw_ring_block_cx)
        mEtCy = findViewById(R.id.et_draw_ring_block_cy)
        mEtR = findViewById(R.id.et_draw_ring_block_r)
        mEtW = findViewById(R.id.et_draw_ring_block_w)
